...
const uint256 hashGenesisBlock("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f99m6x9w1");
...
{
    int64 nSubsidy = 50 * THUNDER;

    // Subsidy is cut in half every 452 years
    nSubsidy >>= (nBestHeight / 23730000);
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // txNew.vout[0].nValue       = 300000000000
        ...
        // Genesis block
        char* pszTimestamp = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks Genesis v01 = Genesis v02 Age of Aquarius (30 / 10 / 2023) = Hail Wise = Genesis v03 ? ? ?";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        txNew.vout[0].nValue       = 50 * THUNDER;
